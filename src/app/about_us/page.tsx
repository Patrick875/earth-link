    ...
    return (
        <div className="overflow-x-hidden">
            ...
            <main className="bg-white">
                <motion.section
                    className='mt-[60px] md:mt-[126px] min-h-[50vh] flex flex-col'
                    initial={{ opacity: 0, y: 60 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    viewport={{ once: false, amount: 0.3 }} // animate on scroll up/down
                >
                    <div className='w-[90%] mx-auto flex flex-col md:flex-row gap-16 flex-1'>
                        <div className='hidden md:flex gap-2 w-full md:w-3/5 '>
                            <div className="flex w-full gap-4">
                                <motion.div
                                    className='relative w-[60%] h-[100%] rounded-[8px]'
                                ...
                                <div className="w-[40%] flex flex-col gap-3">
                                    <motion.div
                                        className='w-full h-[30%] relative rounded-[8px]'
                                    ...
                                    <motion.div
                                        className='w-full flex-1 relative rounded-[8px]'
                                        initial={{ opacity: 0, y: 40 }}
                                        whileInView={{ opacity: 1, y: 0 }}
                ...
                <motion.section
                    className='mt-32 flex flex-col bg-gradient-to-t from-white to-[#F2F2F2]'
                    initial={{ opacity: 0, y: 60 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    viewport={{ once: false, amount: 0.3 }}
                >
                    <div className='w-[90%] mx-auto flex-1 '>
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:gap-12">
                            <motion.div
                                className='w-full md:w-1/2 flex flex-col gap-[24px] p-[32px] rounded-[8px] shadow-md bg-white'
                                initial={{ opacity: 0, x: -60 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                transition={{ duration: 0.8, ease: "easeOut" }}
                                viewport={{ once: false, amount: 0.3 }}
                ...
                <motion.section
                    className="mt-32 flex flex-col pb-16"
                    initial={{ opacity: 0, y: 60 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    viewport={{ once: false, amount: 0.3 }}
                    ...
                    <div className='flex-1 w-[90%] mx-auto'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 md:w-[60%] mx-auto'>
                            {team.map((member, idx) =>
                                <motion.div
                                    key={member.id}
                                    className="col-span-1 p-2 bg-white rounded-[20px] shadow-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300"
                                    initial={{ opacity: 0, y: 40 }}
                                    whileInView={{ opacity: 1, y: 0 }}
